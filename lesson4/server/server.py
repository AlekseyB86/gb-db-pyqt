...
import select
import sys
from lesson4.config import ACTION, PRESENCE, TIME, RESPONSE, OK, WRONG_REQUEST, \
...
from lesson4.descriptors import SockVerify
from lesson4.meta import ServerVerifier
    ...
    def write_messages(self, messages, to_clients, client_list):
        for message, sender in messages:
            if self.alive:
                ...
                elif message[ACTION] == MSG and message[TO] != MAIN_CHANNEL and message[TO] != message[FROM]:
